...
namespace Moox\Wayback\Resources;
...
class WaybackResource extends BaseDraftResource
{
    use HasResourceTabs;
    use HasResourceTaxonomy;

    protected static ?string $model = Wayback::class;

    protected static string|\BackedEnum|null $navigationIcon = 'gmdi-description';

    public static function getModelLabel(): string
    {
        return config('wayback.resources.wayback.single');
    }

    public static function getPluralModelLabel(): string
    {
        return config('wayback.resources.wayback.plural');
    }
    ...
    {
        return config('wayback.navigation_group');
    }
